...
public class ElixirEffectRegistry {
	...
	//Anti Elixirs
	public static final ElixirEffect EFFECT_WEAKNESS = new ElixirEffect(17, "bl.elixir.weakness", new ResourceLocation("thebetweenlands:textures/items/strictlyHerblore/misc/vialGreen.png")).addAttributeModifier(SharedMonsterAttributes.attackDamage, "886d753c-fcf2-4370-99b3-eb8e4fbaabcf", -3.0D, 2).setAntiInfusion();
	public static final ElixirEffect EFFECT_LUMBERING = new ElixirEffect(18, "bl.elixir.lumbering", new ResourceLocation("thebetweenlands:textures/items/strictlyHerblore/misc/vialGreen.png")).addAttributeModifier(SharedMonsterAttributes.movementSpeed, "2c06470c-b549-47e9-893c-0d9950c77716", -0.2D, 2).setAntiInfusion();
