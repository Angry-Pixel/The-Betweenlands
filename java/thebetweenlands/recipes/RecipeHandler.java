...
public class RecipeHandler {
	...
	private static void registerRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(BLItemRegistry.syrmoriteHelmet, 1), "###", "# #", '#', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		GameRegistry.addRecipe(new ItemStack(BLItemRegistry.syrmoriteChestplate, 1), "# #", "###", "###", '#', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		GameRegistry.addRecipe(new ItemStack(BLItemRegistry.syrmoriteLeggings, 1), "###", "# #", "# #", '#', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		GameRegistry.addRecipe(new ItemStack(BLItemRegistry.syrmoriteBoots, 1), "# #", "# #", '#', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		...
		GameRegistry.addRecipe(new ItemStack(BLBlockRegistry.compostBin), "bxb", "x x", "x x", 'x', BLBlockRegistry.weedwoodPlanks, 'b', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		...
		GameRegistry.addRecipe(new ItemStack(BLBlockRegistry.syrmoriteBlock), "xxx", "xxx", "xxx", 'x', ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
		GameRegistry.addShapelessRecipe(ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT, 9), new ItemStack(BLBlockRegistry.syrmoriteBlock));
	...
	private static void registerSmelting() {
		GameRegistry.addSmelting(new ItemStack(BLBlockRegistry.syrmoriteOre), ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT), 0F);
	...
	private static void registerOreDictionary() {
        ...
        OreDictionary.registerOre("ingotSyrmorite", ItemMaterialsBL.createStack(EnumMaterialsBL.SYRMORITE_INGOT));
