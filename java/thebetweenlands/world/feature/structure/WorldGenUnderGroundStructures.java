...
public class WorldGenUnderGroundStructures extends WorldGenerator {
    ...
    public boolean structure3(World world, Random random, int x, int y, int z) {
        ...
        rotatedCubeVolume(world, random, x, y, z, 1, 0, 1, BLBlockRegistry.pitstoneTiles, 0, 4, 1, 4, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 0, 0, BLBlockRegistry.pitstoneBricks, 0, 1, 2, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 0, 5, BLBlockRegistry.pitstoneBricks, 0, 1, 2, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 0, 0, BLBlockRegistry.pitstoneBricks, 0, 1, 2, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 0, 5, BLBlockRegistry.pitstoneBricks, 0, 1, 2, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 1, 0, 0, BLBlockRegistry.pitstoneBrickStairs, 2, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 0, 1, BLBlockRegistry.pitstoneBrickStairs, 0, 1, 1, 4, 0);
        rotatedCubeVolume(world, random, x, y, z, 1, 0, 5, BLBlockRegistry.pitstoneBrickStairs, 3, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 0, 1, BLBlockRegistry.pitstoneBrickStairs, 1, 1, 1, 4, 0);

        rotatedCubeVolume(world, random, x, y, z, 0, 2, 0, BLBlockRegistry.pitstonePillar, 0, 1, 3, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 2, 5, BLBlockRegistry.pitstonePillar, 0, 1, 3, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 2, 0, BLBlockRegistry.pitstonePillar, 0, 1, 3, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 2, 5, BLBlockRegistry.pitstonePillar, 0, 1, 3, 1, 0);

        rotatedCubeVolume(world, random, x, y, z, 0, 5, 0, BLBlockRegistry.pitstoneBricks, 0, 1, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 5, 5, BLBlockRegistry.pitstoneBricks, 0, 1, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 5, 0, BLBlockRegistry.pitstoneBricks, 0, 1, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 5, 5, BLBlockRegistry.pitstoneBricks, 0, 1, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 1, 5, 0, BLBlockRegistry.pitstoneBrickSlab, 8, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 5, 1, BLBlockRegistry.pitstoneBrickSlab, 8, 1, 1, 4, 0);
        rotatedCubeVolume(world, random, x, y, z, 1, 5, 5, BLBlockRegistry.pitstoneBrickSlab, 8, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 5, 1, BLBlockRegistry.pitstoneBrickSlab, 8, 1, 1, 4, 0);

        rotatedCubeVolume(world, random, x, y, z, 1, 6, 0, BLBlockRegistry.pitstoneBrickSlab, 0, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 0, 6, 1, BLBlockRegistry.pitstoneBrickSlab, 0, 1, 1, 4, 0);
        rotatedCubeVolume(world, random, x, y, z, 1, 6, 5, BLBlockRegistry.pitstoneBrickSlab, 0, 4, 1, 1, 0);
        rotatedCubeVolume(world, random, x, y, z, 5, 6, 1, BLBlockRegistry.pitstoneBrickSlab, 0, 1, 1, 4, 0);
