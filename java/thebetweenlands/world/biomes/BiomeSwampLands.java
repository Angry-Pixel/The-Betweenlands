...
extends BiomeGenBaseBetweenlands {
	...
	public BiomeSwampLands(int biomeID, BiomeDecoratorBaseBetweenlands decorator) {
		...
		//this.blSpawnEntries.add(new CaveSpawnEntry(EntityGiantToad.class, (short) 20).setSpawnCheckRadius(30.0D));
		...
		this.blSpawnEntries.add(new CaveSpawnEntry(EntitySwampHag.class, (short) 140).setHostile(true));
