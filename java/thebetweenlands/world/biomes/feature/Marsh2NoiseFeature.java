...
public class Marsh2NoiseFeature extends BiomeNoiseFeature {
	...
	public void generateNoise(int chunkX, int chunkZ,
		...
		this.islandNoise = this.islandNoiseGen.func_151599_a(this.islandNoise, (double) (chunkX * 16), (double) (chunkZ * 16), 16, 16, 0.5D, 0.5D, 1.0D);
		this.fuzzNoise = this.fuzzNoiseGen.func_151599_a(this.fuzzNoise, (double) (chunkX * 16), (double) (chunkZ * 16), 16, 16, 100.5D, 100.5D, 1.0D);
	}
