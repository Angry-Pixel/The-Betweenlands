...
public class DeepWaterNoiseFeature extends BiomeNoiseFeature {
	...
	public void generateNoise(int chunkX, int chunkZ,
		...
		this.islandNoise = this.islandNoiseGen.func_151599_a(this.islandNoise, (double) (chunkX * 16), (double) (chunkZ * 16), 16, 16, 0.05D * 1.0D, 0.05D * 1.0D, 1.0D);
	}
	...
	public void preReplaceStackBlocks(int x, int z, Block[] chunkBlocks,
		...
		for(int y = lowestBlock; y < layerHeight - (layerHeight - lowestBlock) / 2.5f + noise * (layerHeight - lowestBlock) - 2; y++) {
