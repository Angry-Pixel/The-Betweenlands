...
public class ManualEntryEntity extends ManualEntry {
    ...
    public ManualEntryEntity(IManualEntryEntity entity, GuiManualBase manual){
        super("manual." + entity.manualName() + ".title", new ManualPage(new TextWidget(manual, 5, 5, "manual." + entity.manualName() + ".title"), new PictureWidget(manual, (127 / 2) - (entity.pictureWidth()/2), 15, entity.manualPictureLocation(), entity.pictureWidth(), entity.pictureHeight(), entity.manualStats())), new ManualPage(new TextWidget(manual, 5, 5, "manual." + entity.manualName() + ".description")));
    }
}
