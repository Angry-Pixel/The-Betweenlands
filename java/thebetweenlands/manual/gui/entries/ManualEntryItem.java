...
public class ManualEntryItem extends ManualEntry {
    ...
    public ManualEntryItem(IManualEntryItem item, GuiManualBase manual, ManualWidgetsBase... recipes){
        super(new ManualPage(new TextWidget(manual, 5, 5, "manual." + item.manualName(0) + ".title"), new ItemWidget(manual, (127/2)-24, 77, new ItemStack(item.getItem()), 3)), new ManualPage(new TextWidget(manual, 5, 5, "manual." + item.manualName(0)+ ".description")), new ManualPage(recipes));
    }
