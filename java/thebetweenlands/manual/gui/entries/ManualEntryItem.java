...
public class ManualEntryItem extends ManualEntry {
    ...
    public ManualEntryItem(ArrayList<ItemStack> item, String name, GuiManualBase manual, ManualWidgetsBase... recipes) {
        super("manual." + name + ".title", new ManualPage(new TextWidget(manual, 5, 5, "manual." + name + ".title", 1.5f), new ItemWidget(manual, (127 / 2) - 24, 77, item, 3)), new ManualPage(new TextWidget(manual, 5, 5, "manual." + name + ".description")), new ManualPage(recipes));
        this.items = item;
    }

    public ManualEntryItem(String name, ArrayList<IManualEntryItem> items, GuiManualBase manual, ManualWidgetsBase... recipes) {
        super("manual." + name + ".title", new ManualPage(new TextWidget(manual, 5, 5, "manual." + name + ".title", 1.5f), new ItemWidget(manual, (127 / 2) - 24, 77, 3, items)), new ManualPage(new TextWidget(manual, 5, 5, "manual." + name + ".description")), new ManualPageRecipe(manual, items, recipes));
    ...
    public ManualEntryItem(IManualEntryItem item, int meta, GuiManualBase manual, ManualWidgetsBase... recipes) {
        super("manual." + item.manualName(meta) + ".title", new ManualPage(new TextWidget(manual, 5, 5, "manual." + item.manualName(meta) + ".title", 1.5f), new ItemWidget(manual, (127 / 2) - 24, 77, new ItemStack(item.getItem(), 1, meta), 3)), new ManualPage(new TextWidget(manual, 5, 5, "manual." + item.manualName(meta) + ".description")), new ManualPage(recipes));
