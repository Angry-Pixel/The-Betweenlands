...
import thebetweenlands.manual.widgets.text.TextContainer.RangedTag;
import thebetweenlands.manual.widgets.text.TextContainer.Tag;
...
public class FormatTags {
	...
	public static class TagSimple extends RangedTag {
		...
		public TagSimple(String name, EnumChatFormatting format) {
			super(name);
			this.name = name;
			this.format = format;
		}
