...
public class ModelItemCage extends ModelBase {
	...
	public ModelItemCage() {
		textureWidth = 128;
		textureHeight = 64;
		bar2 = new ModelRenderer(this, 9, 24);
		bar2.setRotationPoint(-6.0F, 20.0F, 6.0F);
		bar2.addBox(0.0F, -6.0F, -2.0F, 2, 7, 2, 0.0F);
		...
		bar6 = new ModelRenderer(this, 45, 24);
		bar6.setRotationPoint(-6.0F, 20.0F, 0.0F);
		bar6.addBox(0.0F, -6.0F, -1.0F, 2, 7, 2, 0.0F);
		...
		bar5 = new ModelRenderer(this, 36, 24);
		bar5.setRotationPoint(0.0F, 20.0F, -6.0F);
		bar5.addBox(-1.0F, -6.0F, 0.0F, 2, 7, 2, 0.0F);
