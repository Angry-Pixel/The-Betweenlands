...
public class ModelDragonfly extends ModelBase {
	...
	@Override
	public void setLivingAnimations(EntityLivingBase entity, float swing, float speed, float partialRenderTicks) {		EntityDragonFly dragonFly = (EntityDragonFly) entity;
