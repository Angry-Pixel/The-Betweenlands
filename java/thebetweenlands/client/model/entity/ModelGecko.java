...
//        f1 = 0.4f;
        ...
        float frontOffset = 0.85f;

        walk(legleft_f1, 1 * globalSpeed, 1f * globalDegree, false, 0 + frontOffset, 0f, f, f1);
        walk(legleft_f2, 1 * globalSpeed, 1.5f * globalDegree, false, 2f + frontOffset, -0.4f * globalDegree, f, f1);
        walk(legright_f1, 1 * globalSpeed, 1f * globalDegree, true, 0 + frontOffset, 0f, f, f1);
        walk(legright_f2, 1 * globalSpeed, 1.5f * globalDegree, true, 2f + frontOffset, -0.4f * globalDegree, f, f1);

        walk(legleft_b1, 1 * globalSpeed, 1f * globalDegree, false, 0, -2.5f * globalDegree, f, f1);
        walk(legleft_b2, 1 * globalSpeed, 1f * globalDegree, false, -1f, 2.5f * globalDegree, f, f1);
        walk(legright_b1, 1 * globalSpeed, 1f * globalDegree, true, 0, -2.5f * globalDegree, f, f1);
        walk(legright_b2, 1 * globalSpeed, 1f * globalDegree, true, -1f, 2.5f * globalDegree, f, f1);
    }
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
        ...
        float tongueControl = (int) ((Math.sin(0.15 * frame - Math.cos(0.15 * frame)) + 1) / 2 + 0.5);
        if (tongueControl == 0) tongue.isHidden = true;
        else tongue.isHidden = false;
        walk(tongue, 2, 1f, false, 0, 0, frame, 1);
