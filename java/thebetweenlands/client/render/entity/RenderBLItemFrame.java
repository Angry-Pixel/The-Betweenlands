...
public class RenderBLItemFrame extends RenderItemFrame {
    ...
    public void renderItemFrame(EntityBLItemFrame entity, double x, double y, double z, float yaw, float tick) {
        ...
        GL11.glTranslated(entity.field_146063_b + x - 0.5D - Direction.offsetX[entity.hangingDirection], entity.field_146064_c + y, entity.field_146062_d + z - 0.5D + Direction.offsetZ[entity.hangingDirection]);
    	...
    	//System.out.println(entity.posY);
         ...
         int k = entity.field_146062_d + Direction.offsetZ[entity.hangingDirection];
         GL11.glTranslated((double)i - d3, (double)j - d4, (double)k - d5);
    	 //GL11.glTranslated(entity.field_146063_b - RenderManager.renderPosX, entity.field_146064_c - RenderManager.renderPosY, entity.field_146062_d - RenderManager.renderPosZ);

    	 System.out.println(entity.field_146063_b + " " + entity.field_146064_c + " " + entity.field_146062_d);
    ...
    private void renderEntity(EntityItemFrame p_147915_1_)
    {
        GL11.glPushMatrix();
