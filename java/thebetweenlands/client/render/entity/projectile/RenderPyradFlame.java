...
public class RenderPyradFlame extends Render
{
    ...
    public RenderPyradFlame(float scale){
        this.scale = scale;
    }

    public void doRender(EntityPyradFlame flammeBall, double x, double y, double z, float rotationYaw, float partialTick) {
        GL11.glPushMatrix();
        ...
        IIcon iicon = BLItemRegistry.itemsGeneric.getIcon(ItemGeneric.createStack(EnumItemGeneric.PYRAD_FLAME), 0);
    ...
    protected ResourceLocation getEntityTexture(EntityPyradFlame flammeBall) {
        return TextureMap.locationItemsTexture;
    }

    protected ResourceLocation getEntityTexture(Entity flammeBall) {
        return getEntityTexture((EntityPyradFlame)flammeBall);
    }

    public void doRender(Entity flammeBall, double x, double y, double z, float rotationYaw, float partialTick) {
        doRender((EntityPyradFlame)flammeBall, x, y, z, rotationYaw, partialTick);
    }
}