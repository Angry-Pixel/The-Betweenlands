...
public class ItemRepellerRenderer implements IItemRenderer {
	public static ResourceLocation TEXTURE = new ResourceLocation("thebetweenlands:textures/tiles/repeller.png");
	private final ModelRepeller model = new ModelRepeller();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED_FIRST_PERSON:
			...
			break;
		case INVENTORY:
			renderBlock(0.0F, 0.7F, 0.0F, 1.0D);
			break;
		default:
			break;
		}
