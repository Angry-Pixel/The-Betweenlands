...
public class SwirlEffect extends PostProcessingEffect {
	...
	protected boolean initEffect() {
		this.angleUniformID = OpenGlHelper.func_153194_a(this.getShaderProgram(), "u_angle");
	...
	protected void uploadUniforms() {
		OpenGlHelper.func_153168_a(this.angleUniformID, this.getSingleFloatBuffer(this.angle));
	}
}
