...
public class TileEntityBushRender extends TileEntitySpecialRenderer {
	private static final ResourceLocation FANCY_TEXTURE = new ResourceLocation("thebetweenlands", "textures/blocks/weedWoodLeavesFancy.png");
	private static final ResourceLocation FAST_TEXTURE = new ResourceLocation("thebetweenlands", "textures/blocks/weedWoodLeavesFast.png");
	private static final ResourceLocation STICK_TEXTURE = new ResourceLocation("thebetweenlands", "textures/items/weedWoodStick.png");
	private static int stickDisplayList = -1;
	
	public void renderSticks() {
		if(stickDisplayList == -1) {
			stickDisplayList = GL11.glGenLists(1);
			GL11.glNewList(stickDisplayList, GL11.GL_COMPILE);
			Tessellator tessellator = Tessellator.instance;
			GL11.glPushMatrix();
			GL11.glTranslatef(0.5F, -0.3F, 0.5F);
			GL11.glRotatef(45F, 0F, 0F, 1F);
			GL11.glScalef(0.8F, 0.8F, 0.8F);
			ItemRenderer.renderItemIn2D(tessellator, 0F, 0F, 1F, 1F, 0, 0, 0.0625F);
			GL11.glPopMatrix();
		...
		GL11.glCallList(stickDisplayList);
	}
	
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		/*if (Minecraft.isFancyGraphicsEnabled())
			Minecraft.getMinecraft().renderEngine.bindTexture(FANCY_TEXTURE);
		else
			Minecraft.getMinecraft().renderEngine.bindTexture(FAST_TEXTURE);
		Tessellator tessellator = Tessellator.instance;
		GL11.glPushMatrix();
		...
		if (Minecraft.isFancyGraphicsEnabled()) {
			...
			GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
			GL11.glEnable(GL11.GL_BLEND);
			Minecraft.getMinecraft().renderEngine.bindTexture(STICK_TEXTURE);
			this.renderSticks();
