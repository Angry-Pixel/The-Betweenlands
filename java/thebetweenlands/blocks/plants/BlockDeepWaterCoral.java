...
public class BlockDeepWaterCoral extends BlockSwampWater implements IPlantable, ISickleHarvestable, ISyrmoriteShearable {
	public IIcon iconDeepWaterCoral;

	public BlockDeepWaterCoral() {
		super(BLFluidRegistry.swampWaterDeepWaterCoral, Material.water);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.iconDeepWaterCoral = iconRegister.registerIcon("thebetweenlands:deepWaterCoral");
		this.setSpecialRenderer(new WaterSimplePlantRenderer(this.iconDeepWaterCoral));
