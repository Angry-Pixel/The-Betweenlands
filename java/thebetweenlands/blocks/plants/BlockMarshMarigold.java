...
public class BlockMarshMarigold extends BlockSwampWater implements IPlantable, ISickleHarvestable, ISyrmoriteShearable {
	public IIcon iconMarshMarigoldBottom;
	public IIcon iconMarshMarigoldTop;

	public BlockMarshMarigold() {
		super(BLFluidRegistry.swampWaterMarshMarigold, Material.water);
		setStepSound(Block.soundTypeGrass);
		setBlockName("thebetweenlands.marshMarigold");
		setHardness(0.5F);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.iconMarshMarigoldBottom = iconRegister.registerIcon("thebetweenlands:marshMarigoldBottom");
		this.iconMarshMarigoldTop = iconRegister.registerIcon("thebetweenlands:marshMarigoldTop");
		this.setSpecialRenderer(new WaterSimplePlantRenderer(this.iconMarshMarigoldBottom, this.iconMarshMarigoldTop));
