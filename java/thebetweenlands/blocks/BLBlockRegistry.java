...
public class BLBlockRegistry {
	...
	public static final Block betweenstoneBricksMirage = new BlockBetweenstoneBricksMirage(Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
