...
import thebetweenlands.client.render.block.BlockBogBeanRenderer;
...
import thebetweenlands.client.render.block.BlockGoldenClubRenderer;
...
public class ClientProxy extends CommonProxy {
	...
	public enum BlockRenderIDs {
		...
		DOUBLE_PLANTS, RUBBER_LOG, WEEDWOOD_BUSH, SWAMP_WATER, SWAMP_REED, STALACTITE, ROOT, MODEL_PLANT, GOLDEN_CLUB, BOG_BEAN, DOOR;
	...
	public void preInit() {
		...
		RenderingRegistry.registerBlockHandler(new BlockBogBeanRenderer());
		RenderingRegistry.registerBlockHandler(new BlockGoldenClubRenderer());		
