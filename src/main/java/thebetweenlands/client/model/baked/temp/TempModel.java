...
public class TempModel implements IDynamicBakedModel {
    
    private final TextureAtlasSprite texture;
	private final ItemTransforms transforms;
	private final List<BakedQuad> quads;

    public TempModel(TextureAtlasSprite texture, ItemTransforms transforms, Transformation identity) {
