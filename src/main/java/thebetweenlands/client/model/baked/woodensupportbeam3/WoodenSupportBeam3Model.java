...
public class WoodenSupportBeam3Model implements IDynamicBakedModel {
    ...
    public WoodenSupportBeam3Model(TextureAtlasSprite texture, TextureAtlasSprite particleTexture, ItemTransforms transforms, Transformation identity) {
		...
		WoodenSupportBeam3Geometry.build(builder);
