...
public class WightModelOld<T extends Entity> extends MowzieModelBase<T> {
	...
	public WightModelOld(ModelPart root) {
	...
	public WightModelOld<T> setRenderHeadOnly(boolean headOnly) {
