...
public class AspectrusCrop4Model {
	...
	public static LayerDefinition makeModel() {
		...
		var fruit1 = partDefinition.addOrReplaceChild("fruit1", CubeListBuilder.create()
				.texOffs(80, 0).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
		...
		var fruit2 = partDefinition.addOrReplaceChild("fruit2", CubeListBuilder.create()
				.texOffs(80, 8).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
			PartPose.offsetAndRotation(-4.947116985729956F, 20.143506022144425F, 6.884119689159517F, -2.868448625652681F, 0.591841149351277F, 3.141592653589793F));
		var fruit3 = partDefinition.addOrReplaceChild("fruit3", CubeListBuilder.create()
				.texOffs(80, 16).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
		...
		var fruit4 = partDefinition.addOrReplaceChild("fruit4", CubeListBuilder.create()
				.texOffs(80, 24).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
		...
		var fruit5 = partDefinition.addOrReplaceChild("fruit5", CubeListBuilder.create()
				.texOffs(80, 32).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
		...
		var fruit6 = partDefinition.addOrReplaceChild("fruit6", CubeListBuilder.create()
				.texOffs(80, 40).addBox(-1.5F, 0.0F, -1.5F, 3, 4, 3),
	...
	public static LayerDefinition makeAspectModel() {
		...
		var fruit1aspect = partDefinition.addOrReplaceChild("fruit1aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(6.995595194465089F, 20.901375629624447F, 4.3292998523654305F, -2.9595548126067857F, -1.0927506446736501F, -3.141592653589793F));
		var fruit2aspect = partDefinition.addOrReplaceChild("fruit2aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(-4.646123928498683F, 22.06936106867976F, 6.436363595696842F, -2.868448625652681F, 0.591841149351277F, 3.141592653589793F));
		var fruit3aspect = partDefinition.addOrReplaceChild("fruit3aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(-2.9259704049301796F, 23.704073607463094F, -6.840122340168901F, 0.182212373908208F, 0.36425021489121645F, 0.0F));
		var fruit4aspect = partDefinition.addOrReplaceChild("fruit4aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(-1.78386733070658F, 15.409970027826894F, 7.258398131651733F, -2.7317893452215247F, 0.18203784098300896F, 3.141592653589793F));
		var fruit5aspect = partDefinition.addOrReplaceChild("fruit5aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(5.456659186365834F, 11.274257386994794F, 5.519686598804911F, -2.913827186204533F, -0.6829473363053811F, 3.141592653589793F));
		var fruit6aspect = partDefinition.addOrReplaceChild("fruit6aspect", CubeListBuilder.create()
				.texOffs(100, 0).addBox(-1.0F, -1.5F, -1.0F, 2, 3, 2),
			PartPose.offsetAndRotation(-8.063243352246799F, 18.76020367280518F, 2.0522342300057987F, -2.868448625652681F, 1.3658946726107624F, 3.141592653589793F));
