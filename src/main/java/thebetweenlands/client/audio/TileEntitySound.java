...
public class TileEntitySound<T extends TileEntity> extends MovingSound {
	public final T tile;
	...
	@Override
	public void update() {
		if(this.fadeOut || this.tile == null || !this.tile.hasWorldObj() || !this.tile.getWorld().isBlockLoaded(this.tile.getPos())
