...
public class WindAmbienceType extends AmbienceType {
	...
	public boolean isActive() {
		...
		return false/*ridingEntity instanceof EntityGrapplingHookNode || ridingEntity instanceof EntityVolarkite || ridingEntity instanceof EntityDraeton*/;
	}
	...
	public SoundEvent getSound() {
		return SoundRegistry.ROPE_SWING.get();
	}
