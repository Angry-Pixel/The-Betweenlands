...
public class BLModelLayers {
	...
	public static final ModelLayerLocation JELLYFISH_CAVE = register("jellyfish_cave");
	...
	public static final ModelLayerLocation SWAMP_HAG = register("swamp_hag");
	...
	public static final ModelLayerLocation DECAY_PIT_SHIELD = register("decay_pit_shield");
