...
public class SludgeRenderer extends MobRenderer<Sludge, SludgeModel> {
	...
	@Override
	protected void scale(Sludge entity, PoseStack stack, float partialTick) {
	...
	public static class SludgeOuterLayer extends RenderLayer<Sludge, SludgeModel> {

		public SludgeOuterLayer(RenderLayerParent<Sludge, SludgeModel> renderer) {
			super(renderer);
		}

		public void render(PoseStack stack, MultiBufferSource buffer, int packedLight, Sludge entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
