...
public interface RenderTypeModifier<Context> {
	 ...
	 */
	void beforeSetupRenderState(RenderType originalRenderType, Context context);
	 ...
	 */
	void setupRenderState(RenderType originalRenderType, Context context);
	 ...
	 * @param context A custom data storage class for this modifier
	 */
	void clearRenderState(RenderType originalRenderType, Context context);
	 ...
	 * @param context A custom data storage class for this modifier
	 */
	void afterClearRenderState(RenderType originalRenderType, Context context);

	/**
	 * @return a new instance of the modifier's default context
	 */
    Context createDefaultData(RenderType originalRenderType);
}
