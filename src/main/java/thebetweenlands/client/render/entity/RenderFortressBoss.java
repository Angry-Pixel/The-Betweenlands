	...
	public void doRender(EntityFortressBoss entity, double x, double y, double z, float yaw, float partialTicks) {
		...
		for(int i = 0; i <= 19; i++) {
			...
			for(int l = 0; l < ((shieldAnimationTicks > 0 && shieldAnimationTicks <= 20) ? 4 : layers); l++) {
				...
				tu3 = cu + tu3 * sin;
				tv3 = cv + tv3 * cos;
				buffer.pos(v1[0]+centerX/len*explode, v1[1]+centerY/len*explode, v1[2]+centerZ/len*explode).tex(tu1, tv1).color(r, g, b, a).endVertex();
				buffer.pos(v2[0]+centerX/len*explode, v2[1]+centerY/len*explode, v2[2]+centerZ/len*explode).tex(tu2, tv2).color(r, g, b, a).endVertex();
				buffer.pos(v3[0]+centerX/len*explode, v3[1]+centerY/len*explode, v3[2]+centerZ/len*explode).tex(tu3, tv3).color(r, g, b, a).endVertex();
			}
		...
		for(int i = 0; i <= 19; i++) {
			...
			double centerZ = (v1[2]+v2[2]+v3[2])/3;
			double len = Math.sqrt(centerX*centerX + centerY*centerY + centerZ*centerZ);
			buffer.pos(v1[0]+centerX/len*explode, v1[1]+centerY/len*explode, v1[2]+centerZ/len*explode).color(0.5F, 0.6F, 1F, 0.5F).endVertex();
			buffer.pos(v2[0]+centerX/len*explode, v2[1]+centerY/len*explode, v2[2]+centerZ/len*explode).color(0.5F, 0.6F, 1F, 0.5F).endVertex();
			buffer.pos(v3[0]+centerX/len*explode, v3[1]+centerY/len*explode, v3[2]+centerZ/len*explode).color(0.5F, 0.6F, 1F, 0.5F).endVertex();
		}
		tessellator.draw();
		...
		for(int i = 0; i <= 19; i++) {
			...
			double centerZ = (v1[2]+v2[2]+v3[2])/3;
			double len = Math.sqrt(centerX*centerX + centerY*centerY + centerZ*centerZ);
			buffer.pos(v1[0]+centerX/len*explode, v1[1]+centerY/len*explode, v1[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
			buffer.pos(v2[0]+centerX/len*explode, v2[1]+centerY/len*explode, v2[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
			buffer.pos(v2[0]+centerX/len*explode, v2[1]+centerY/len*explode, v2[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
			buffer.pos(v3[0]+centerX/len*explode, v3[1]+centerY/len*explode, v3[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
			buffer.pos(v3[0]+centerX/len*explode, v3[1]+centerY/len*explode, v3[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
			buffer.pos(v1[0]+centerX/len*explode, v1[1]+centerY/len*explode, v1[2]+centerZ/len*explode).color(0.5F, 0.75F, 1F, 1.0F).endVertex();
		}
		tessellator.draw();
