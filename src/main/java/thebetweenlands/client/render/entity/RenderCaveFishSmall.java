...
public class RenderCaveFishSmall extends RenderLiving<EntityCaveFishSmall> {
    ...
    public RenderCaveFishSmall(RenderManager rendermanagerIn) {
        super(rendermanagerIn, CAVE_FISH_MODEL, 0.5f);
    }

	@Override
	public void doRender(EntityCaveFishSmall cave_fish, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityCaveFishSmall entity) {
        return TEXTURE;
    }
}
