...
public class ParticleBreakingBL extends ParticleBreaking implements IParticleSpriteReceiver {
	protected ParticleBreakingBL(World worldIn, double posXIn, double posYIn, double posZIn, ItemStack itemIn, float scale) {
		super(worldIn, posXIn, posYIn, posZIn, itemIn);
		this.particleScale = scale;
	}

	protected ParticleBreakingBL(World worldIn, double posXIn, double posYIn, double posZIn, double mx, double my, double mz, ItemStack itemIn, float scale) {
		super(worldIn, posXIn, posYIn, posZIn, itemIn);
		this.particleScale = scale;
		this.motionX = mx;
        this.motionY = my;
