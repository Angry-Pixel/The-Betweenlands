...
public class RiftVariant {
	...
	public RiftVariant(ResourceLocation maskTexture, ResourceLocation overlayTexture, float minYaw, float maxYaw, 
			float minPitch, float maxPitch, float minRoll, float maxRoll, float minScale, float maxScale, boolean mirrorU,
			boolean mirrorV) {
