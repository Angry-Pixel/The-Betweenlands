...
public class OverworldSkyRenderer extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		float[] afloat = this.calcSunriseSunsetColors(this.getCelestialAngle(partialTicks), partialTicks);
		...
		if (afloat != null)
		{
			...
			GlStateManager.rotate(MathHelper.sin(this.getCelestialAngleRadians(partialTicks)) < 0.0F ? 180.0F : 0.0F, 0.0F, 0.0F, 1.0F);
		...
		GlStateManager.pushMatrix();
		float f16 = 1.0F - this.getRainStrength(partialTicks);
		GlStateManager.color(1.0F, 1.0F, 1.0F, f16);
		GlStateManager.rotate(-90.0F, 0.0F, 1.0F, 0.0F);
		GlStateManager.rotate(this.getCelestialAngle(partialTicks) * 360.0F, 1.0F, 0.0F, 0.0F);
		float f17 = 30.0F;
		...
		tessellator.draw();
		GlStateManager.disableTexture2D();
		float f15 = this.getStarBrightness(partialTicks) * f16;
	...
	private void updateFogColor(float partialTicks, Minecraft mc)
	{
		...
		Vec3d vec3d1 = this.getFogColor(partialTicks);
		...
		{
			double d0 = MathHelper.sin(this.getCelestialAngleRadians(partialTicks)) > 0.0F ? -1.0D : 1.0D;
		...
		float f8 = this.getRainStrength(partialTicks);
