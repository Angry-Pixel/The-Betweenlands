...
public class BLSkyRendererOld extends IRenderHandler {
	...
	public final GeometryBuffer clipPlaneBuffer = null;// = new GeometryBuffer(true);
	public static final BLSkyRenderer INSTANCE = new BLSkyRenderer();

	public BLSkyRendererOld() {
	...
	private void renderAuroras(Minecraft mc, float partialTicks) {
		...
		if(mc.world != null) {
			event = BetweenlandsWorldStorage.forWorld(mc.world).getEnvironmentEventRegistry().auroras;
		}
		if(event != null) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		if(mc.world != null) {
			if(BetweenlandsWorldStorage.forWorld(mc.world).getEnvironmentEventRegistry().auroras.isActive()) {
				GlStateManager.disableFog();
