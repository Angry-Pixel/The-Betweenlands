...
/**
 * The default Forge ModelFluid with some tweaks to apply a tint
 */
public final class ModelFluidBL implements IModelCustomData
{
	public static final ModelFluidBL WATER = new ModelFluidBL(FluidRegistry.WATER);
	public static final ModelFluidBL LAVA = new ModelFluidBL(FluidRegistry.LAVA);
	private final Fluid fluid;

	public ModelFluidBL(Fluid fluid)
	{
		this.fluid = fluid;
	}
	...
	@Override
	public ModelFluidBL process(ImmutableMap<String, String> customData)
	{
		...
		return new ModelFluidBL(FluidRegistry.getFluid(fluid));
	}
}