...
public class ModelChiromawTame extends MowzieModelBase {
	...
	public void setLivingAnimations(EntityLivingBase entity, float swing, float speed, float partialRenderTicks) {
		...
		if (chiromaw.isSitting() || chiromaw.isRiding()) {
			...
			globalSpeed = 0.1f;
			globalDegree = 0.1f;
			frame = chiromaw.ticksExisted + partialRenderTicks;
			...
			leg_right2.rotateAngleZ -= stance * 2;
			leg_left2.rotateAngleZ += stance * 2;
			
			leg_right2.rotateAngleX -= stance * 1.5f;
			leg_left2.rotateAngleX -= stance * 1.5f;
			
			leg_right2.rotateAngleY -= stance * 0.15f;
			leg_left2.rotateAngleY += stance * 0.15f;
			
			head_base.rotateAngleX -= stance;
			body_base.rotateAngleX += stance;
