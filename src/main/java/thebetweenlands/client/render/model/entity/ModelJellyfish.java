...
public class ModelJellyfish extends ModelBase {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
		...
		tentacles_left1a.rotateAngleZ = -0.091106186954104F * 2F + MathHelper.cos(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_right1a.rotateAngleZ = 0.091106186954104F * 2F - MathHelper.cos(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_front1a.rotateAngleX = -0.091106186954104F * 2F + MathHelper.cos(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_back1a.rotateAngleX = 0.091106186954104F * 2F - MathHelper.cos(limbSwing * 1.0F) * adjustedLimbSwingAmount* 1F;

		tentacles_left1b.rotateAngleZ = 0.136659280431156F + MathHelper.sin(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_right1b.rotateAngleZ = -0.136659280431156F - MathHelper.sin(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_front1b.rotateAngleX = 0.136659280431156F + MathHelper.sin(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
		tentacles_back1b.rotateAngleX = -0.136659280431156F - MathHelper.sin(limbSwing * 1.0F) * adjustedLimbSwingAmount * 1F;
	}
