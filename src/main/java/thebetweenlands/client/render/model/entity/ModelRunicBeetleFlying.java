 ...
 */
public class ModelRunicBeetleFlying extends ModelBase {
	...
	public ModelRunicBeetleFlying() {
		...
		this.thorax_main.setRotationPoint(0.0F, 18.0F, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		this.jaw_left1a.rotateAngleY = -0.36425021489121656F + 0.1f + crunch * 0.15f;
		this.jaw_left1a.rotateAngleZ = 0.091106186954104F - 0.2f + crunch * 0.15f;

		this.jaw_right1a.rotateAngleY = 0.36425021489121656F - 0.1f - crunch * 0.15f;
		this.jaw_right1a.rotateAngleZ = 0.091106186954104F + 0.2f - crunch * 0.15f;
		...
		this.antennae_left1a.rotateAngleZ = flop * 0.05f;
		this.antennae_right1a.rotateAngleZ = -flop * 0.05f;

		this.leg_left_front1a.rotateAngleZ = 0 - flop * 0.05f;
		this.leg_left_mid1a.rotateAngleZ = 0 - flop * 0.05f;
		this.leg_left_back1a.rotateAngleX = -1.2747884856566583F - flop * 0.05f;

		this.leg_right_front1a.rotateAngleZ = 0 + flop * 0.05f;
		this.leg_right_mid1a.rotateAngleZ = 0 + flop * 0.05f;
		this.leg_right_back1a.rotateAngleX = -1.2747884856566583F - flop * 0.05f;
	}
