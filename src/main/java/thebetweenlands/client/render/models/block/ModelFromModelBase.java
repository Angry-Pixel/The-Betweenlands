...
public class ModelFromModelBase implements IModel {
	...
	public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		...
		return new ModelBakedModelBase(state.apply(Optional.<IModelPart>absent()), map, format, this.model, bakedTextureGetter.apply(this.texture), this.width, this.height);
	}
	...
	public static class ModelBakedModelBase implements IPerspectiveAwareModel {
		...
		private ModelBakedModelBase(Optional<TRSRTransformation> transformation, ImmutableMap<TransformType, TRSRTransformation> transforms, VertexFormat format, ModelBase model, TextureAtlasSprite texture, int width, int height) {
