...
public class BetweenlandsFluidTagsGenerator extends FluidTagsProvider {
	...
	public BetweenlandsFluidTagsGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, @Nullable ExistingFileHelper existingFileHelper) {
