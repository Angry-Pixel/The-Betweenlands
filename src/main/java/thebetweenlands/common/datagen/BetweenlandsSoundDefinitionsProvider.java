...
public class BetweenlandsSoundDefinitionsProvider extends SoundDefinitionsProvider {

	public BetweenlandsSoundDefinitionsProvider(PackOutput output, ExistingFileHelper helper) {
