...
public class BetweenlandsDimensionTypeTagProvider extends TagsProvider<DimensionType> {
	...
	public BetweenlandsDimensionTypeTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, @Nullable ExistingFileHelper existingFileHelper) {
