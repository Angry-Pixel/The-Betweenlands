...
//		this.add(BlockRegistry.TAR_BEAST_SPAWNER.get(), LootTable.lootTable());
		...
		this.dropSelf(BlockRegistry.DULL_LAVENDER_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.MAROON_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.SHADOW_GREEN_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.CAMELOT_MAGENTA_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.SAFFRON_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.CARIBBEAN_GREEN_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.VIVID_TANGERINE_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.CHAMPAGNE_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.RAISIN_BLACK_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.SUSHI_GREEN_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.ELM_CYAN_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.CADMIUM_GREEN_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.LAVENDER_BLUE_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.BROWN_RUST_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.MIDNIGHT_PURPLE_MUD_BRICK_SHINGLE_ROOF.get());
		this.dropSelf(BlockRegistry.PEWTER_GREY_MUD_BRICK_SHINGLE_ROOF.get());
