...
public class BLBlockTagProvider extends BlockTagsProvider {
	...
	public static final TagKey<Block> MOVING_WALL_UNBREAKABLE = tag("moving_wall_unbreakable");
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(MOVING_WALL_UNBREAKABLE).add(
			BlockRegistry.MUD_BRICK_ALCOVE.get(),
			BlockRegistry.WORM_PILLAR.get(),
			BlockRegistry.SLUDGY_WORM_PILLAR_1.get(),
			BlockRegistry.SLUDGY_WORM_PILLAR_2.get(),
			BlockRegistry.SLUDGY_WORM_PILLAR_3.get(),
			BlockRegistry.SLUDGY_WORM_PILLAR_4.get(),
			BlockRegistry.SLUDGY_WORM_PILLAR_5.get(),
			BlockRegistry.MUD_TILES.get(),
			BlockRegistry.MUD_TILES.get(),
			BlockRegistry.DECAYED_MUD_TILES.get(),
			BlockRegistry.CRACKED_MUD_TILES.get(),
			BlockRegistry.CRACKED_DECAYED_MUD_TILES.get(),
			BlockRegistry.BROKEN_MUD_TILES.get(),
			BlockRegistry.MUD_BRICK_STAIRS.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_STAIRS_1.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_STAIRS_2.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_STAIRS_3.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_STAIRS_4.get(),
			BlockRegistry.MUD_BRICK_SLAB.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_SLAB_1.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_SLAB_2.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_SLAB_3.get(),
			BlockRegistry.SLUDGY_MUD_BRICK_SLAB_4.get(),
			BlockRegistry.MUD_BRICKS.get(),
			BlockRegistry.CARVED_MUD_BRICKS.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICKS_1.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICKS_2.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICKS_3.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICKS_4.get(),
			BlockRegistry.CARVED_MUD_BRICK_EDGE.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICK_EDGE_1.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICK_EDGE_2.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICK_EDGE_3.get(),
			BlockRegistry.SLUDGY_CARVED_MUD_BRICK_EDGE_4.get(),
			BlockRegistry.MUD_BRICK_SPIKE_TRAP.get(),
			BlockRegistry.MUD_TILES_SPIKE_TRAP.get(),
			BlockRegistry.CLIMBABLE_MUD_BRICKS.get(),
			BlockRegistry.DUNGEON_DOOR_COMBINATION.get(),
			BlockRegistry.DUNGEON_DOOR_RUNES.get(),
			BlockRegistry.MIMIC_DUNGEON_DOOR_RUNES.get(),
			BlockRegistry.CRAWLER_DUNGEON_DOOR_RUNES.get(),
			BlockRegistry.MUD_BRICK_WALL.get()
		);
