...
public class BLBlockRecipeProvider {
	...
	public static void buildRecipes(RecipeOutput output, HolderLookup.Provider registries) {
		...
		dying(output, BlockRegistry.DULL_LAVENDER_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.DULL_LAVENDER_DYE);
		dying(output, BlockRegistry.MAROON_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.MAROON_DYE);
		dying(output, BlockRegistry.SHADOW_GREEN_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.SHADOW_GREEN_DYE);
		dying(output, BlockRegistry.CAMELOT_MAGENTA_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.CAMELOT_MAGENTA_DYE);
		dying(output, BlockRegistry.SAFFRON_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.SAFFRON_DYE);
		dying(output, BlockRegistry.CARIBBEAN_GREEN_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.CARIBBEAN_GREEN_DYE);
		dying(output, BlockRegistry.VIVID_TANGERINE_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.VIVID_TANGERINE_DYE);
		dying(output, BlockRegistry.CHAMPAGNE_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.CHAMPAGNE_DYE);
		dying(output, BlockRegistry.RAISIN_BLACK_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.RAISIN_BLACK_DYE);
		dying(output, BlockRegistry.SUSHI_GREEN_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.SUSHI_GREEN_DYE);
		dying(output, BlockRegistry.ELM_CYAN_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.ELM_CYAN_DYE);
		dying(output, BlockRegistry.CADMIUM_GREEN_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.CADMIUM_GREEN_DYE);
		dying(output, BlockRegistry.LAVENDER_BLUE_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.LAVENDER_BLUE_DYE);
		dying(output, BlockRegistry.BROWN_RUST_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.BROWN_RUST_DYE);
		dying(output, BlockRegistry.MIDNIGHT_PURPLE_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.MIDNIGHT_PURPLE_DYE);
		dying(output, BlockRegistry.PEWTER_GREY_MUD_BRICK_SHINGLE_ROOF, BlockRegistry.MUD_BRICK_SHINGLE_ROOF, ItemRegistry.PEWTER_GREY_DYE);
