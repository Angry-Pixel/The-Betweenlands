...
public class EntitySludgeOld extends EntityMob implements IEntityBL {
	...
	public EntitySludgeOld(World world) {
		super(world);
		isImmuneToFire = true;
		setSize(1.1F, 1.2F);
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(1, new EntityAIAttackMelee(this, 0.4D, false));
	...
	public void onUpdate() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (getActive()) {
				...
				if (getAttackTarget() == null && this.worldObj.rand.nextInt(350) == 0 && !this.isInWater()) {
