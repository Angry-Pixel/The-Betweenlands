...
public class EntityCaveFishSmall extends EntityCreature implements IEntityBL {
	
	private EntityAIFollowTarget followLeader;

    public EntityCaveFishSmall(World world) {
        super(world);
        setSize(0.3F, 0.2F);
        setAir(80);
        this.moveHelper = new EntityCaveFishSmall.CaveFishMoveHelper(this);
    ...
    protected void initEntityAI() {
    	tasks.addTask(0, new EntityAIFollowTarget(this, new EntityAIFollowTarget.FollowClosest(this, EntityCaveFish.class, 16), 14D, 0.5F, 16.0F, false));
    ...
    static class CaveFishMoveHelper extends EntityMoveHelper {
        private final EntityCaveFishSmall fish;

        public CaveFishMoveHelper(EntityCaveFishSmall fish) {
            super(fish);
            this.fish = fish;
        }
