...
public class Emberling extends TamableAnimal implements BLEntity, Enemy, BLEntityWithSpawnRules <Emberling> {
	...
	@Override
	public boolean canSpawnHere(EntityType<Emberling> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
		return level.getBlockState(pos.below()).is(BlockRegistry.HEARTHGROVE_BARK) && level.getDifficulty() != Difficulty.PEACEFUL;
	}
