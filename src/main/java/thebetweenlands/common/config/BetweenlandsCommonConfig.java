	...
	public BetweenlandsCommonConfig(ModConfigSpec.Builder builder) {
		builder.comment("Configure handling for items outside of The Betweenlands").translation("config.thebetweenlands.general").push("Overworld");
		{
			OVERWORLD.rottenFoodWhitelist = builder
					...
					.defineListAllowEmpty("rottenFoodWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.rottenFoodBlacklist = builder
					...
					.defineListAllowEmpty("rottenFoodBlacklist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.taintingWhitelist = builder
					...
					.defineListAllowEmpty("taintingWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.taintingBlacklist = builder
					...
					.defineListAllowEmpty("taintingBlacklist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.fireToolWhitelist = builder
					...
					.defineListAllowEmpty("fireToolWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.fireToolBlacklist = builder
					...
					.defineListAllowEmpty("fireToolBlacklist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.fertilizerWhitelist = builder
					...
					.defineListAllowEmpty("fertilizerWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.fertilizerBlacklist = builder
					...
					.defineListAllowEmpty("fertilizerBlacklist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.toolWeaknessWhitelist = builder
					...
					.defineListAllowEmpty("toolWeaknessWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.toolWeaknessBlacklist = builder
					...
					.defineListAllowEmpty("toolWeaknessBlacklist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
			...
			OVERWORLD.torchWhitelist = builder
					...
					.defineListAllowEmpty("torchWhitelist", new ArrayList<>(), () -> "", ItemListProperty::isValidString);
