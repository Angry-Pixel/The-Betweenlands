...
import thebetweenlands.common.world.gen.feature.legacy.WorldGenWeedwoodTree;

public class WeedwoodSapling extends BetweenlandsSapling {

	WorldGenWeedwoodTree generator = new WorldGenWeedwoodTree();

	public WeedwoodSapling(Properties p_48756_) {
		super(p_48756_);
	}
