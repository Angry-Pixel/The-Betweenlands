...
public class ItemRubberBoots extends ItemBLArmor {
	...
	public static boolean isEntityWearingRubberBoots(Entity entity) {
		return entity instanceof EntityPlayer && ((EntityPlayer)entity).inventory.armorInventory[0] != null && ((EntityPlayer)entity).inventory.armorInventory[0].getItem() instanceof ItemRubberBoots;
	}
