...
public class ItemSkullMask extends ItemBLArmor {
    ...
    public void renderHelmetOverlay(ItemStack stack, EntityPlayer player, ScaledResolution resolution, float partialTicks) {
        ...
        vertexBuffer.pos(0, height, -90).tex(offset, 1);
        vertexBuffer.pos(width, height, -90).tex(1 - offset, 1);
        vertexBuffer.pos(width, 0, -90).tex(1 - offset, 0);
        vertexBuffer.pos(0, 0, -90).tex(offset, 0);
        tessellator.draw();
