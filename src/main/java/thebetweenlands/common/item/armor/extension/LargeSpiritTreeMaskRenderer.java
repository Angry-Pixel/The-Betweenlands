...
public class LargeSpiritTreeMaskRenderer extends MaskRenderer {
	...
	public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entity, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> original) {
		return new HumanoidArmorModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(BLModelLayers.LARGE_SPIRIT_TREE_MASK));
	}
