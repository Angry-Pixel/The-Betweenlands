...
public class BLMaterialRegistry {
	...
	public static final ArmorMaterial ARMOR_AMPHIBIAN = EnumHelper.addArmorMaterial("amphibian", "amphibian", 12, new int[]{1, 2, 3, 1}, 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0f);
