...
public class ItemWeedwoodRowboat extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand) {
        ...
        List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(player, player.getEntityBoundingBox().expand(look.x * REACH, look.y * REACH, look.z * REACH).expand(1, 1, 1));
        ...
        if (!world.getCollisionBoxes(rowboat, rowboat.getEntityBoundingBox().expand(-0.1, -0.1, -0.1)).isEmpty()) {
