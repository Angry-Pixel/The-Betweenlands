...
public class ItemTestRune extends Item implements ITintedItem {
	...
	public ItemTestRune(AbstractRune.Blueprint<?> blueprint) {
	...
	private static class Factory implements IRuneContainerFactory {
		private ItemTestRune item;

		private Factory(ItemTestRune item) {
			this.item = item;
		}
