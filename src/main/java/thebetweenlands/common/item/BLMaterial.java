...
public class BLMaterial {
    ...
    public static final ToolMaterial TOOL_BETWEENSTONE = EnumHelper.addToolMaterial("betweenstone", 1, 320, 4.0F, 1.0F, 5);
    ...
    public static final ArmorMaterial ARMOR_BL_CLOTH = EnumHelper.addArmorMaterial("blCloth", "blCloth", 12, new int[]{1, 3, 2, 1}, 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.0f);
    public static final ArmorMaterial ARMOR_LURKER_SKIN = EnumHelper.addArmorMaterial("lurkerSkin", "lurkerSkin", 12, new int[]{1, 3, 2, 1}, 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.0f);
    public static final ArmorMaterial ARMOR_BONE = EnumHelper.addArmorMaterial("slimyBone", "slimyBone", 6, new int[]{2, 5, 3, 1}, 0, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1.0f);
