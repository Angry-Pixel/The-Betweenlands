...
public class RubberTreeConfig implements FeatureConfiguration {
	...
	public static final Codec<RubberTreeConfig> CODEC = RecordCodecBuilder.create((p_67849_) -> {
		return p_67849_.group(Codec.list(TargetBlockState.CODEC).fieldOf("targets").forGetter((p_161027_) -> {
			return p_161027_.targetStates;
		})).apply(p_67849_, RubberTreeConfig::new);
	});
	
	public RubberTreeConfig(List<TargetBlockState> targetstates) {
