...
import thebetweenlands.common.generation.trees.RubberTree;
import thebetweenlands.common.registries.BlockRegistry;

public class RubberTreeFeature extends Feature<RubberTreeConfig> {

	RubberTree generator = new RubberTree();

	public RubberTreeFeature(Codec<RubberTreeConfig> p_65786_) {
		super(p_65786_);
	}

	@Override
	public boolean place(FeaturePlaceContext<RubberTreeConfig> p_159749_) {
		...
		// Place
		return generator.generate(level, pos.below(depth), rand);
	}
}
