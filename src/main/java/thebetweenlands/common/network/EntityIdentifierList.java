...
public class EntityIdentifierList {
	...
	public static final StreamCodec<ByteBuf, EntityIdentifierList> STREAM_CODEC = StreamCodec.of(EntityIdentifierList::encode, EntityIdentifierList::decode);
	...
	private EntityIdentifierList(int size) {
		entityIdentifiers = new ArrayList<>(size);
	}

	public EntityIdentifierList() {
		entityIdentifiers = new ArrayList<>();
	}

	public EntityIdentifierList(List<Entity> entities) {
		entityIdentifiers = new ArrayList<>(entities.size());
