...
import thebetweenlands.common.world.BLCaveCarver;
...
public class CarverRegistry {
	...
	public static final DeferredHolder<WorldCarver<?>, WorldCarver<CaveCarverConfiguration>> CAVES_BETWEENLANDS = CARVER_TYPES.register("caves_betweenlands", () -> new BLCaveCarver(CaveCarverConfiguration.CODEC));
