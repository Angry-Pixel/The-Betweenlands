...
public class RecipeRegistry {
	...
	private static void registerBoilingPotRecipes() {
		...
		SteepingPotRecipes.addRecipe(FluidRegistry.getFluid("drinkable_brew"), 2, FluidRegistry.getFluid("clean_water"), EnumItemMisc.PHEROMONE_THORAX_CLUTCH.create(1), EnumItemMisc.PHEROMONE_THORAX_CLUTCH.create(1), EnumItemMisc.PHEROMONE_THORAX_CLUTCH.create(1), EnumItemMisc.PHEROMONE_THORAX_CLUTCH.create(1));
