...
public class AttachmentRegistry {
	...
	public static final DeferredHolder<AttachmentType<?>, AttachmentType<LastKilledData>> LAST_KILLED = ATTACHMENT_TYPES.register("last_killed", () -> AttachmentType.builder(LastKilledData::new).serialize(LastKilledData.CODEC).sync(LastKilledData.STREAM_CODEC).build());
