...
public class RuneRegistry {
	...
	public static void preInit() {
		...
		ItemRune.register(RuneCategory.TOKEN, RuneTier.TIER_1, AspectRegistry.CELAWYNN, new FormationRuneItemProperties(new ResourceLocation(ModInfo.ID, "formation")));
		ItemRune.register(RuneCategory.TOKEN, RuneTier.TIER_2, AspectRegistry.CELAWYNN, new PatternRuneItemProperties(new ResourceLocation(ModInfo.ID, "pattern")));
