...
public class LootFunctionRegistry {
	...
	public static final DeferredHolder<LootItemFunctionType<?>, LootItemFunctionType<SetAspectFromBlockEntityFunction>> SET_ASPECT_FROM_BLOCK_ENTITY = FUNCTIONS.register("set_aspect_from_block_entity", () -> new LootItemFunctionType<>(SetAspectFromBlockEntityFunction.CODEC));
