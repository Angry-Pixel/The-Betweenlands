...
public class ItemRegistry {
	...
	public static final DeferredItem<Item> SYRMORITE_HELMET = ITEMS.register("syrmorite_helmet", () -> new ArmorItem(ArmorMaterialRegistry.SYRMORITE, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
	public static final DeferredItem<Item> SYRMORITE_CHESTPLATE = ITEMS.register("syrmorite_chestplate", () -> new ArmorItem(ArmorMaterialRegistry.SYRMORITE, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
	public static final DeferredItem<Item> SYRMORITE_LEGGINGS = ITEMS.register("syrmorite_leggings", () -> new ArmorItem(ArmorMaterialRegistry.SYRMORITE, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
	public static final DeferredItem<Item> SYRMORITE_BOOTS = ITEMS.register("syrmorite_boots", () -> new ArmorItem(ArmorMaterialRegistry.SYRMORITE, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(16))));
	...
	public static final DeferredItem<Item> GLOWING_GOOP = ITEMS.register("glowing_goop_item", () -> new GlowingGoopItem(BlockRegistry.GLOWING_GOOP.get(), new Item.Properties()));
