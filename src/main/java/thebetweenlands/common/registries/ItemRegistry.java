...
public class ItemRegistry {
    ...
    public static final Item TEST_RUNE_RIGHT_CLICK = new ItemTestRune(new RuneRightClick.Blueprint());
    public static final Item TEST_RUNE_WATER = new ItemTestRune(new RuneWater.Blueprint());
