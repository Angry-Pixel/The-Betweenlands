...
public class DataComponentRegistry {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> ANIMATED = COMPONENTS.register("animated", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<GemSingerTarget>> GEM_SINGER_TARGET = COMPONENTS.register("gem_singer_target", () -> DataComponentType.<GemSingerTarget>builder().persistent(GemSingerTarget.CODEC).networkSynchronized(GemSingerTarget.STREAM_CODEC).build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> GLU = COMPONENTS.register("glu", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> PESTLE_ACTIVE = COMPONENTS.register("active", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> RING_OF_SUMMONING_ACTIVE = COMPONENTS.register("ring_of_summoning_active", () -> DataComponentType.<Boolean>builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
