...
public class EntityRegistry {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<BonePuppetMelee>> BONE_PUPPET_MELEE = registerWithAttributes("bone_puppet_melee", EntityType.Builder.of(BonePuppetMelee::new, MobCategory.MONSTER).sized(0.6F, 1.4F), BonePuppetMelee::registerAttributes);
