...
public class EntityRegistry {
	...
	//rock snot
	public static final DeferredHolder<EntityType<?>, EntityType<RockSnot>> ROCK_SNOT = registerWithEgg("rock_snot", EntityType.Builder.of(RockSnot::new, MobCategory.MISC).sized(1F, 0.5F).eyeHeight(0.5F), 0xC4B7DB, 0x2D0000, BasicProximitySpawnerExtended::registerAttributes);
