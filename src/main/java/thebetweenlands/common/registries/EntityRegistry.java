...
public class EntityRegistry {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<BubblerCrabBubble>> BUBBLER_CRAB_BUBBLE = register("bubbler_crab_bubble", EntityType.Builder.<BubblerCrabBubble>of(BubblerCrabBubble::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(64).updateInterval(1).setShouldReceiveVelocityUpdates(true));
