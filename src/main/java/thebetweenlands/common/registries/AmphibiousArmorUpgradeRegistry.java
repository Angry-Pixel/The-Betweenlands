...
public class AmphibiousArmorUpgradeRegistry {
	...
	public static final DeferredHolder<AmphibiousArmorUpgrade, SimpleAmphibiousArmorUpgrade> FISH_SIGHT = UPGRADES.register("fish_sight", () -> new FishSightArmorUpgrade(64, AmphibiousArmorUpgrade.DamageEvent.ON_DAMAGE, stack -> stack.is(ItemRegistry.GLOWING_GOOP), EquipmentSlot.HEAD));
