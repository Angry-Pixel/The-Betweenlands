...
public class FoodSicknessHandler {
	...
	public static void onStartItemUse(LivingEntityUseItemEvent.Start event) {
		...
		if (player != null && !itemStack.isEmpty() && FoodSicknessHandler.isFoodSicknessEnabled(event.getEntity().level()) && itemStack.is(BetweenlandsItemTagProvider.GIVES_FOOD_SICKNESS)) {
