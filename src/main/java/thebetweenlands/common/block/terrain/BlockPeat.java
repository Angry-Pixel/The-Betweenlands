...
public class BlockPeat extends Block {
	...
	public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
		boolean canWalk = entity instanceof EntityPlayer && ((EntityPlayer)entity).inventory.armorInventory.get(0) != null &&
				((EntityPlayer)entity).inventory.armorInventory.get(0).getItem() instanceof ItemRubberBoots;
		if(!canWalk) {
