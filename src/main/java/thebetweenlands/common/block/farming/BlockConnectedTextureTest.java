...
public class BlockConnectedTextureTest extends BasicBlock {
	//-1, +1, -1, quadrant 0
	...
	public BlockConnectedTextureTest() {
	...
	public IBlockState getExtendedState(IBlockState oldState, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean[] connectionArray = getConnectionArray(worldIn, pos, EnumFacing.UP, s -> s.getBlock() instanceof BlockConnectedTextureTest);
