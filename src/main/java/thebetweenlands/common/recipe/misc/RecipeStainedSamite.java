...
public class RecipeStainedSamite  extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    @Override
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if(!stack.isEmpty()) {
                if(i == 4) {
                    ...
                    if(stack.getItem() != Item.getItemFromBlock(BlockRegistry.SAMITE))
                        return false;
                }
            } else {
                return false;
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        ...
        if(inv.getSizeInventory() == 9) {
            ...
            if(dye != ItemStack.EMPTY) {
                return new ItemStack(BlockRegistry.SAMITE, 8, dye.getMetadata());
            }
        }
