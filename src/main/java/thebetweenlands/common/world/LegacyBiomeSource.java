...
import thebetweenlands.common.registries.ResourceKeys;
...
public class LegacyBiomeSource extends BiomeSource {
    ...
    public static class LegacyBiomeSourceSettings {
        ...
        // Settings codec
        public static final MapCodec<LegacyBiomeSourceSettings> SETTINGS_CODEC = RecordCodecBuilder.mapCodec((codec) -> {return codec.group(
