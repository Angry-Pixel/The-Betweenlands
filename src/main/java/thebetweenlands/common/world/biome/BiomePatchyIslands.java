...
public class BiomePatchyIslands extends BiomeBetweenlands {
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new SurfaceSpawnEntry(21, EntityEmberlingWild.class, EntityEmberlingWild::new, (short) 20).setSurfacePredicate(state -> state.getBlock() == BlockRegistry.LOG_HEARTHGROVE).setHostile(true).setGroupSize(1, 1).setSpawnCheckRadius(32));
		...
		entries.add(new CaveSpawnEntry(22, EntityStalker.class, EntityStalker::new, (short) 13).setHostile(true).setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(16).setSpawningInterval(6000));
