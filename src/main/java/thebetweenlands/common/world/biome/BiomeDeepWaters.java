...
public class BiomeDeepWaters extends BiomeBetweenlands {
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new CaveSpawnEntry(19, EntityStalker.class, EntityStalker::new, (short) 12).setHostile(true).setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(16).setSpawningInterval(6000));
