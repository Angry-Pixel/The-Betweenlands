...
public class BiomeDeepWaters extends BiomeBetweenlands {
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new PitstoneCaveSpawnEntry(19, EntityStalker.class, EntityStalker::new, (short) 12).setHostile(true).setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(16).setSpawningInterval(6000));
		entries.add(new CaveSpawnEntry(20, EntitySwarm.class, EntitySwarm::new, (short) 120).setHostile(true).setSpawnCheckRadius(32.0D));
	}
}
