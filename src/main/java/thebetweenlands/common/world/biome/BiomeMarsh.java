...
public class BiomeMarsh extends BiomeBetweenlands {
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new GreeblingSpawnEntry(12, (short) 20).setGroupSize(1, 3).setSpawnCheckRadius(64.0D).setGroupSpawnRadius(4).setSpawningInterval(3000));
		...
		entries.add(new SurfaceSpawnEntry(6, EntityChiromaw.class, (short) 40).setHostile(true).setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(20.0D));
