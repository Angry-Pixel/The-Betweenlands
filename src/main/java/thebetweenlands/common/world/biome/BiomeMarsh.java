...
import thebetweenlands.common.world.gen.biome.feature.MarshFeature;
...
public class BiomeMarsh extends BiomeBetweenlands {
	...
	public BiomeMarsh() {
		super();
		this.setWeight(25);
		this.biomeName = "betweenlands_marsh";
	}
	...
	public Biome biomeBuilder() {
		...
		this.biomeGenerator = new BiomeGenerator(new BiomeDecorator(List.of(new MarshFeature(),
