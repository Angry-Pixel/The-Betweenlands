...
public class BiomeRaisedIsles extends BiomeBetweenlands {
	...
	public BiomeRaisedIsles() {
		super(new ResourceLocation(ModInfo.ID, "raised_isles"), 
				...
				.setRainfall(0.9F));
		this.setWeight(16);
		this.getBiomeGenerator().setDecoratorFactory(generateDecoratorFactory(BiomeDecoratorRaisedIsles.class))
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new SurfaceSpawnEntry(23, EntityAnadia.class, EntityAnadia::new, (short) 60).setCanSpawnInWater(true).setHostile(false).setGroupSize(1, 5));
	}
}
