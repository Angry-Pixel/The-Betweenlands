...
public class BLTreeGrowers {
	...
	public static final TreeGrower SPIRIT_TREE = new TreeGrower("spirit_tree", Optional.empty(), Optional.of(ConfiguredFeatureRegistry.SMALL_SPIRIT_TREE), Optional.empty());
