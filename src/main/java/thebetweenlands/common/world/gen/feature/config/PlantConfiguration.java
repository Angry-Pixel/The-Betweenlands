...
public record PlantConfiguration(BlockState state, int offset, int attempts, boolean underwater) implements FeatureConfiguration {
	public static final Codec<PlantConfiguration> CODEC = RecordCodecBuilder.create(
		...
		).apply(instance, PlantConfiguration::new));
}
