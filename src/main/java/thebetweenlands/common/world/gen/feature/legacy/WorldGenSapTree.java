...
public class WorldGenSapTree extends WorldGenHelper {
    ...
    private void createBranch(Level world, Random rand, BlockPos pos, int dir, int branchLength) {
        boolean branchBend = false;
        int y = 0;
        for (int i = 0; i <= branchLength; ++i) {
    ...
    private void createLeaves(Level world, BlockPos pos, boolean top) {
        world.setBlock(pos.offset(0, 0, 1), leaves, 2);
        world.setBlock(pos.offset(0, 0, - 1), leaves, 2);
        world.setBlock(pos.offset(1, 0, 0), leaves, 2);
        world.setBlock(pos.offset(- 1, 0, 0), leaves, 2);
    ...
    private void createRoots(Level world, BlockPos pos) {
        world.setBlock(pos.offset(0, 0, 1), roots, 2);
        world.setBlock(pos.offset(0, 0, - 1), roots, 2);
        world.setBlock(pos.offset(1, 0, 0), roots, 2);
        world.setBlock(pos.offset(- 1, 0, 0), roots, 2);
