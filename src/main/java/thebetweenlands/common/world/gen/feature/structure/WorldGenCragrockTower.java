...
public class WorldGenCragrockTower extends WorldGenHelper {
	...
	private boolean tower(World world, Random random, int x, int y, int z) {
		...
		rotatedSpawner(world, x, y, z, 8, 2, 13, direction, "thebetweenlands.termite").setMaxEntities(6).setDelay(120, 300).setSpawnInAir(false);
		...
		rotatedSpawner(world, x, y, z, 8, 17, 10, direction, "thebetweenlands.chiromaw").setMaxEntities(4).setCheckRange(16.0D).setSpawnRange(3).setDelay(180, 500);
		...
		rotatedSpawner(world, x, y, z, 8, 26, 10, direction, "thebetweenlands.swamp_hag").setMaxEntities(3).setCheckRange(16.0D).setDelay(180, 500).setSpawnInAir(false);
		...
		rotatedSpawner(world, x, y, z, 8, 44, 10, direction, "thebetweenlands.wight").setMaxEntities(2).setCheckRange(24.0D).setDelay(300, 600).setSpawnInAir(false);
		...
		rotatedSpawner(world, x, y, z, 8, 54, 5, direction, "thebetweenlands.swamp_hag").setMaxEntities(3).setCheckRange(10.0D).setDelay(150, 500).setSpawnInAir(false);
		...
		rotatedSpawner(world, x, y, z, 8, 54, 15, direction, "thebetweenlands.wight").setMaxEntities(2).setCheckRange(24.0D).setDelay(300, 600).setSpawnInAir(false);
