...
public class WorldGenWightFortress extends WorldGenerator {
	...
	private Block limestonePolished = BlockRegistry.POLISHED_LIMESTONE;
	private Block limestoneChiselled = BlockRegistry.LIMESTONE_CHISELED;
	private Block limestoneBrickSlab = BlockRegistry.LIMESTONE_BRICK_SLAB;
	private Block limestonePolishedCollapsing = BlockRegistry.WEAK_POLISHED_LIMESTONE;
	private Block betweenstone = BlockRegistry.BETWEENSTONE;
	private Block betweenstoneSmooth = BlockRegistry.SMOOTH_BETWEENSTONE;
	private Block betweenstoneSmoothMossy = BlockRegistry.MOSSY_SMOOTH_BETWEENSTONE;
	private Block betweenstoneTiles = BlockRegistry.BETWEENSTONE_TILES;
	private Block betweenstoneTilesMossy = BlockRegistry.MOSSY_BETWEENSTONE_TILES;
	private Block betweenstoneTilesCracked = BlockRegistry.CRACKED_BETWEENSTONE_TILES;
	private Block betweenstoneTilesCollapsing = BlockRegistry.WEAK_BETWEENSTONE_TILES;
	private Block betweenstoneTilesMossyCollapsing = BlockRegistry.WEAK_MOSSY_BETWEENSTONE_TILES;
	private Block betweenstoneBrickStairs = BlockRegistry.BETWEENSTONE_BRICK_STAIRS;
	private Block betweenstoneBrickStairsMossy = BlockRegistry.MOSSY_BETWEENSTONE_BRICK_STAIRS;
	private Block betweenstoneBrickStairsCracked = BlockRegistry.CRACKED_BETWEENSTONE_BRICK_STAIRS;
	private Block betweenstoneBrickSlab = BlockRegistry.BETWEENSTONE_BRICK_SLAB;
	private Block betweenstoneBrickWall = BlockRegistry.BETWEENSTONE_BRICK_WALL;
	private Block betweenstoneBrickWallMossy = BlockRegistry.MOSSY_BETWEENSTONE_BRICK_WALL;
	private Block betweenstoneBrickWallCracked = BlockRegistry.CRACKED_BETWEENSTONE_BRICK_WALL;
	private Block betweenstoneBricks = BlockRegistry.BETWEENSTONE_BRICKS;
	private Block betweenstoneBricksMirage = BlockRegistry.BETWEENSTONE_BRICKS_MIRAGE;
	private Block betweenstoneBricksMossy = BlockRegistry.MOSSY_BETWEENSTONE_BRICKS;
	private Block betweenstoneBricksCracked = BlockRegistry.CRACKED_BETWEENSTONE_BRICKS;
	private Block betweenstonePillar = BlockRegistry.BETWEENSTONE_PILLAR;
	private Block betweenstoneStairsSmooth = BlockRegistry.SMOOTH_BETWEENSTONE_STAIRS;
	private Block betweenstoneStairsSmoothMossy = BlockRegistry.MOSSY_SMOOTH_BETWEENSTONE_STAIRS;
	private Block betweenstoneTilesFortress = BlockRegistry.GLOWING_BETWEENSTONE_TILE;
	private Block stagnantWater = BlockRegistry.STAGNANT_WATER;
	//private Block spikeTrap = BlockRegistry.spikeTrap;
	//private Block swordStone = BlockRegistry.itemCage;
	private Block root = BlockRegistry.ROOT;
	//private Block possessedBlock = BlockRegistry.possessedBlock;
	private Block chest = BlockRegistry.WEEDWOOD_CHEST;
	private Block lootPot1 = BlockRegistry.LOOT_POT;
	private Block lootPot2 = BlockRegistry.LOOT_POT;
	private Block lootPot3 = BlockRegistry.LOOT_POT;
	//private BlockBLSpawner spawner = BlockRegistry.blSpawner;
	//private Block obviousSign = BlockRegistry.weedwoodWallSign;
	//private Block energyBarrier = BlockRegistry.energyBarrier;
	private Block valoniteBlock = BlockRegistry.VALONITE_BLOCK;
	private Block syrmoriteBlock = BlockRegistry.SYRMORITE_BLOCK;
	private Block octineBlock = BlockRegistry.OCTINE_BLOCK;
	private Block mushroomBlackHat = BlockRegistry.BLACK_HAT_MUSHROOM;
	private Block mushroomBulbCapped = BlockRegistry.BULB_CAPPED_MUSHROOM;
	private Block mushroomflatHead = BlockRegistry.FLAT_HEAD_MUSHROOM;
