...
public class NibbletwigTree extends FeatureHelper<FeatureHelperConfiguration> {

	Direction[] HORIZONTALS = {Direction.EAST, Direction.WEST, Direction.NORTH, Direction.SOUTH};

	public NibbletwigTree(Codec<FeatureHelperConfiguration> codec) {
		super(codec);
	}
	...
	public boolean place(FeaturePlaceContext<FeatureHelperConfiguration> context) {
		...
		if (!this.rotatedCubeCantReplace(world, context, x, y + 2, z, -2, 0, -2, 5, height, 5, 0)) {
