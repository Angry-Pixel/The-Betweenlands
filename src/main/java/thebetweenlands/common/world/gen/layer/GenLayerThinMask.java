...
public class GenLayerThinMask extends GenLayerBetweenlands {
	...
	public GenLayerThinMask(long seed, GenLayer parentGenLayer, int id, int range, float removeChance) {
		super(seed);
	...
	public static GenLayer thin(long seed, GenLayer layer, int id, int range, float removeChance, int num) {
