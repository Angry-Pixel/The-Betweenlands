package thebetweenlands.common.gem;
...
import thebetweenlands.common.gem.EntityGem.Type;
...
public enum CircleGem {
	...
	private CircleGem(String name, int id) {
		this.name = name;
		this.id = id;
	}
	...
	public static void addGemPropertyOverrides(Item item) {
		item.addPropertyOverride(new ResourceLocation("gem"), new IItemPropertyGetter() {
			...
			public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
				return CircleGem.getGem(stack).id;
			}
		});
	}
	...
	public static void setGem(ItemStack stack, CircleGem gem) {
		...
		stack.getTagCompound().setString("blCircleGem", gem == null ? "none" : gem.name);
	}
	...
	public static CircleGem getGem(ItemStack stack) {
		if(stack.getTagCompound() != null) {
			return CircleGem.fromName(stack.getTagCompound().getString("blCircleGem"));
		}
	...
	public static EntityGem getGem(Entity entity, int slot) {
		...
		return new EntityGem(CircleGem.NONE, Type.BOTH);
	}
}
