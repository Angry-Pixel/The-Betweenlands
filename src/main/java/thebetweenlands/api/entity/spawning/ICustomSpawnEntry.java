...
public interface ICustomSpawnEntry extends IWeightProvider {
	 ...
	 * @return
	 */
	ICustomSpawnEntry setWeight(short weight);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setSpawningInterval(int interval);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setGroupSize(int min, int max);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setChunkLimit(int limit);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setWorldLimit(int limit);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setSubChunkLimit(int limit);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setHostile(boolean hostile);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setSpawnCheckRadius(double radius);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setSpawnCheckRangeY(double y);
	 ...
	 * @return
	 */
	ICustomSpawnEntry setGroupSpawnRadius(double radius);
