...
public record CarvingMasks(CarvingMask airCarvingMask, CarvingMask liquidCarvingMask) {
...
//		return new CarvingMasks(carvingMasks, airCarvingMask, liquidCarvingMask);
		...
		CarvingMask airCarvingMask = protoChunk.getOrCreateCarvingMask(Carving.AIR);
		CarvingMask liquidCarvingMask = protoChunk.getOrCreateCarvingMask(Carving.LIQUID);
		return new CarvingMasks(airCarvingMask, liquidCarvingMask);
	}
