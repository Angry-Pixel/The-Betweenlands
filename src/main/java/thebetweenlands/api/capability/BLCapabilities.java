...
//		public static final ItemCapability<ILifeCrystalHandler, @Nullable ItemAccess> ITEM = ItemCapability.create(TheBetweenlands.prefix("life_crystal"), ILifeCrystalHandler.class, ItemAccess.class);
	...
	public static class CorrosionHandler {

		public static final ItemCapability<ICorrosionHandler, @Nullable Void> ITEM = ItemCapability.createVoid(TheBetweenlands.prefix("corrosion"), ICorrosionHandler.class);
