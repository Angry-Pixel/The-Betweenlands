...
public interface IConnectedTextureBlock {
	...
	public default IConnectionRules createConnectionRules(BlockAndTintGetter level, BlockPos pos, BlockState state) {
	 ...
	 * @return
	 */
	public default IConnectionRules getConnectionRules(BlockAndTintGetter level, BlockPos pos, BlockState state) {
	 ...
	 * @return
	 */
	public default boolean isFaceConnectedTexture(BlockAndTintGetter level, BlockPos pos, BlockState builder, Direction face) {
		return true;
	}
