...
public interface IConnectionRules {
	 ...
	 */
	public default BlockAndTintGetter getBlockAccessCache(BlockAndTintGetter world, BlockPos pos) {
		return world;
	}
	 ...
	 * @return
	 */
	public default boolean canConnectThrough(BlockAndTintGetter world, BlockPos pos, Direction face, BlockPos to) {
	...
	public static boolean isSideSolid(BlockAndTintGetter world, BlockState state, BlockPos pos, Direction face) {
