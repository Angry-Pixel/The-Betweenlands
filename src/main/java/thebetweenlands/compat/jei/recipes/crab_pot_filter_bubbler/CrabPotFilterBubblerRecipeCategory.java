...
public class CrabPotFilterBubblerRecipeCategory implements IRecipeCategory {
    private final ResourceLocation backgroundLocation = new ResourceLocation(ModInfo.ID + ":textures/gui/manual/crab_pot_filter_grid_bubbler.png");
    @Nonnull
    ...
    public String getUid() {
        return ModInfo.ID + ":crab_pot_filter_bubbler";
    }

    @Override
    public String getTitle() {
        return TranslationHelper.translateToLocal("jei.thebetweenlands.recipe.crab_pot_filter_bubbler");
    }
