...
public class EmiBubblerCrabFilterRecipe extends BLEmiRecipe<BubblerCrabPotFilterRecipe> {
	...
	public EmiBubblerCrabFilterRecipe(RecipeHolder<BubblerCrabPotFilterRecipe> recipe) {
		super(BetweenlandsEMICompat.BUBBLER_CRAB_FILTER, recipe, 91, 83);
	}
